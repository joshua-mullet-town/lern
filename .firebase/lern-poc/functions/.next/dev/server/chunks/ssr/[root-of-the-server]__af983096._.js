...
"[project]/components/rating/MasterRatingForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MasterRatingForm({ rating, competency, learner }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Rating submitted successfully');
            router.push('/master');
            router.refresh();
        } catch (error) {
            console.error('Error submitting rating:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to submit rating. Please try again.');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af983096._.js.map